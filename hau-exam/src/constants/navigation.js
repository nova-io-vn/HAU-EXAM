...
export const navigationByRole={
  ...
  [roles.USER]:[dashboard,{label:'Câu hỏi của tôi',to:routes.questions,icon:'Q',end:true},{label:'Tạo câu hỏi',to:routes.newQuestion,icon:'+'},{label:'Tạo sinh AI',to:routes.generate,icon:'A'},{label:'Tài liệu',to:routes.documents,icon:'D'},{label:'Chatbot',to:routes.chat,icon:'C'},notifications],
}
