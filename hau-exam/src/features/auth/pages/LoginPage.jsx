...
export function LoginPage() {
  const [form, setForm] = useState({ lecturerCode: "", password: "" });
  ...
  return (
    <AuthLayout
      ...
      description="Sử dụng mã giảng viên và mật khẩu để truy cập không gian làm việc."
      footer={
        <span>
    ...
    >
      <AuthAlert>{location.state?.message || error}</AuthAlert>
      <form className="auth-form" onSubmit={submit}>
        <Input
          label="Mã giảng viên / Cán bộ"
          name="lecturerCode"
