...
- Name: critical.spec.js >> forgot password reaches OTP and reset screens
- Location: e2e\critical.spec.js:5:1
...
Received string:  "http://127.0.0.1:4173/forgot-password"
Timeout: 5000ms

Call log:
  - Expect "toHaveURL" with timeout 5000ms
    14 × locator resolved to <html lang="en">…</html>
       - unexpected value "http://127.0.0.1:4173/forgot-password"
...
- main:
  - region "Quên mật khẩu":
    ...
    - heading "Quên mật khẩu" [level=1]
    - paragraph: Nhập mã giảng viên để yêu cầu mã OTP.
    - alert: Không thể kết nối tới máy chủ. Vui lòng thử lại.
    - text: Mã giảng viên
    - textbox "Mã giảng viên": E2E_USER
    - button "Gửi mã OTP"
