...
- Name: critical.spec.js >> register reaches pending approval
- Location: e2e\critical.spec.js:4:1
...
Expected pattern: /registration-pending/
Received string:  "http://127.0.0.1:4173/register"
Timeout: 5000ms

Call log:
  - Expect "toHaveURL" with timeout 5000ms
    14 × locator resolved to <html lang="en">…</html>
       - unexpected value "http://127.0.0.1:4173/register"
...
- main:
  - region "Đăng ký tài khoản":
    - link "H HAU-EXAM":
      ...
      - text: H
      - strong: HAU-EXAM
    - paragraph: ĐẠI HỌC KIẾN TRÚC HÀ NỘI
    - heading "Đăng ký tài khoản" [level=1]
    - paragraph: Tài khoản mới cần được quản trị viên hệ thống xác nhận.
    - alert: Không thể kết nối tới máy chủ. Vui lòng thử lại.
    - text: Mã giảng viên
    - textbox "Mã giảng viên": E2E_NEW_USER
    - text: Mật khẩu
    - textbox "Mật khẩu": test-password
    - button "Đăng ký"
