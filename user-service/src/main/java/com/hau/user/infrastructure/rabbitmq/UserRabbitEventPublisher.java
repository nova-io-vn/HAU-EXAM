...
import com.hau.user.infrastructure.rabbitmq.contract.UserChangedPayload;
...
public class UserRabbitEventPublisher implements UserEventPublisher {
    ...
    private void publish(String type,String key,UserProfile u,UUID correlationId){
        ...
        var payload=new UserChangedPayload(u.getId(),u.getLecturerCode(),u.getRole(),u.getFacultyId(),u.getStatus());
