package com.hau.user.infrastructure.persistence.entity;
...
public class ProcessedEventEntity {
    ...
    public ProcessedEventEntity(UUID eventId,String eventType,Instant processedAt){this.eventId=eventId;this.eventType=eventType;this.processedAt=processedAt;}
