...
public interface AiKnowledgeChunkRepository extends JpaRepository<AiKnowledgeChunkEntity,UUID>{List<AiKnowledgeChunkEntity> findByDocumentIdOrderByChunkIndex(UUID documentId);void deleteByDocumentId(UUID documentId);}
