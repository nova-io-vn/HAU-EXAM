...
public class ContactController {
    private final JpaContactRequestRepository repository; private final EmailSender email;
    public ContactController(JpaContactRequestRepository repository,EmailSender email){this.repository=repository;this.email=email;}
