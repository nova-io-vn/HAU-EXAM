package com.hau.auth.presentation.advice;

import com.hau.auth.domain.exception.AuthAccountNotFoundException;
import com.hau.auth.domain.exception.DomainException;
import com.hau.auth.domain.exception.LecturerCodeAlreadyExistsException;
import com.hau.auth.presentation.response.ApiErrorResponse;
import com.hau.auth.presentation.response.FieldValidationError;
