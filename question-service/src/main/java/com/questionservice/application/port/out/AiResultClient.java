...
public interface AiResultClient {
    ...
    record GeneratedQuestion(String sourceId, String content, String imageUrl, String storageKey, QuestionType type,
                             Difficulty difficulty, UUID topicId, List<GeneratedOption> options) {
    }

    record GeneratedOption(String label, String content, String imageUrl, String storageKey, boolean correct,
                           int sortOrder) {
    }
}
